                                    ...
                                    <div class="widget-header bordered no-actions d-flex align-items-center">
                                        <table width="100%" border="0">
                                            <tr>
                                                ...
                                                <td align="right"><a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#NewAdmission" data-id="<?=$item['customer_id'];?>"><i class="la la-plus"></i> New Admission</a></td>
                                            </tr>
                                        </table>                                        
                                    </div>
                                    <div class="widget-body">
