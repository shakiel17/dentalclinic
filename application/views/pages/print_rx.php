<div style="width:400px; border:0px solid black; float:right;">
    ...
    <br>
    <img src="<?=base_url('design/assets/images/rx.png');?>" width="30" style="margin-left:20px; position:absolute;">    
    <br>
    ...
    <table width="100%" border="0" style="font-size:12px; font-family:Arial" cellpadding="0" cellspacing="0">
        <tr>
