...
<html lang="en">
    ...
    <body class="bg-fixed-01">
        ...
        <div id="preloader">
            <div class="canvas">
                <img src="<?=base_url('design/assets/img/logo.png');?>" alt="logo" class="loader-logo">
                ...
                <div class="col-12 my-auto">
                    <div class="lock-form mx-auto">
                        <div class="photo-profil">
                            ...
                            <img src="<?=base_url('design/assets/img/avatar/avatar-01.jpg');?>" alt="..." class="img-fluid rounded-circle">
                        </div>
